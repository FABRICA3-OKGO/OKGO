 ...
 * @author Alves
 */
public class InicioOld extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
