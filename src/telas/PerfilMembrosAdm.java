 ...
 * @author cassi
 */
public class PerfilMembrosAdm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setBounds(80, 140, 40, 30);
        ...
        jButtonExpulsar.setBackground(new java.awt.Color(255, 102, 102));
        jButtonExpulsar.setForeground(new java.awt.Color(51, 51, 51));
        jButtonExpulsar.setText("Expulsar");
        jButtonExpulsar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonExpulsarActionPerformed(evt);
            }
        });
    ...
    private void jButtonExpulsarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExpulsarActionPerformed
         Object[] options = { "Cancelar", "Confirmar" };
        int escolha = (JOptionPane.showOptionDialog(null, "Tem certeza que deseja expulsar esse usuário?", "Expulsar usuário?",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerfilMembrosAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void ChamarExpulsar(String usuarioId) {
        grupoDAO gru = new grupoDAO();
            gru.Expulsar(usuarioId, jLabelIdGrupo.getText()); //enviar nota
        MeusGrupos meusGrupos = new MeusGrupos();
        meusGrupos.setVisible(true);
        dispose();
    }
